...
class PortfolioOptimizer:
    ...
    def optimize_portfolio(self, tickers, prices, year, quarter, initial_weights=None, capital=10000):
        ...
        try:
            ...
            # Reemplazamos Rf_trimestral por CRP trimestral
            CRP_trim = self.get_crp_trimestral()
            Rf_daily = CRP_trim / len(returns)
            ...
            # CAPM ex-post usando CRP_trim como Rf
            ...
            return {
                ...
                'expected_return_capm': None,  # se calcula en run_quarterly_analysis
