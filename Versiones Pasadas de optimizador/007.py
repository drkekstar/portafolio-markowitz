...
class PortfolioOptimizer:
    def __init__(self, data_folder='data_acciones', risk_premium_type='Country'):
        ...
        # A) Sólo transaction_cost (la prima viene de CSV)
        self.market_params = {
            'transaction_cost': 0.0275  # 2.75%
        }
        # B) Tipo de prima a usar
    ...
    def print_results(self, results):
        """
        Imprime en consola y log los resultados completos, incluyendo:
        - Fechas filtradas por retorno >|50%|
        - Fechas filtradas por precio >|50%|
        """
        ...
        rf_tr = self.get_quarter_risk_premium(int(year_q), quarter)
        ...
        # 6) Mostrar fechas filtradas de retornos
        ...
        # 7) Mostrar fechas filtradas de precios
        logger.info("FECHAS FILTRADAS (precio con salto > 50%) por acción:")
        for t in results['acciones']:
...
if __name__ == "__main__":
    ...
    for year, quarter in quarters:
        ...
        script_name = os.path.basename(__file__)  # e.g. "006.py"
        logger.info("\n" + "="*50)
